...
export const locales = {
  'zh-TW': {
    ...
    visitTranslate: {
      ...
      directionLabel: '翻譯方向',
      inputLabel: '探訪句子',
      inputPlaceholder: '輸入長者講嘅廣東話，例如：我想飲水。',
  ...
  'zh-CN': {
    ...
    visitTranslate: {
      ...
      directionLabel: '翻译方向',
      inputLabel: '探访句子',
      inputPlaceholder: '输入长者讲的粤语，例如：我想饮水。',
  ...
  'en': {
    ...
    visitTranslate: {
      ...
      inputLabel: 'Visit sentence',
      inputPlaceholder: 'Type what the resident said in Cantonese, e.g. 我想飲水。',
